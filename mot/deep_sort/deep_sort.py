...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, cls_ids, confidences, ori_img):
        ...
        self.tracker.update(detections, ids)
        ...
        for track in self.tracker.tracks:
            ...
            track_type = track.id
            outputs.append(np.array([x1, y1, x2, y2, track_id, track_type], dtype=np.int))
        if len(outputs) > 0:
