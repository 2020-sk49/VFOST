...
class VideoTracker(object):
    ...
    def __enter__(self):
        ...
        if self.args.save_path:
            ...
            print(args.VIDEO_PATH.split('/')[-1:])
            name_results="tracks_"+args.VIDEO_PATH.split('/')[-1:][0].split('.')[0]+".txt"
            print(name_results)
            # self.save_video_path = os.path.join(self.args.save_path, "results.avi")
            self.save_results_path = os.path.join(self.args.save_path, name_results)
    ...
    def run(self):
        ...
        while self.vdo.grab():
            ...
            if len(outputs) > 0:
                ...
                results.append((idx_frame - 1, bbox_tlwh, identities, type))
...
def parse_args():
    ...
    parser.add_argument("--config_detection", type=str, default="mot/configs/yolov3.yaml")
    parser.add_argument("--config_deepsort", type=str, default="mot/configs/deep_sort.yaml")
