...
# os.system('pip3 install --upgrade fvcore --ignore-installed PyYAML')
# os.system('pip uninstall numpy -y')
# os.system('pip install numpy==1.18.2')
# now_file = os.path.abspath(__file__)
# root_file = os.path.join(now_file, '../', '../')
# sys.path.insert(0, '/home/sk49/new_workspace/trj/detectron2-master/projects/PointRend')
# sys.path.insert(0, '/home/sk49/new_workspace/trj/detectron2-master')
...
def get_parser():
    ...
    parser.add_argument(
        ...
        default="/home/sk49/new_workspace/trj/detectron2-master/projects/PointRend/configs/SemanticSegmentation/pointrend_semantic_R_101_FPN_1x_cityscapes.yaml",
    ...
    parser.add_argument(
        ...
        default=['MODEL.WEIGHTS', "/home/sk49/new_workspace/trj/pointrend_sem_city_1x.pkl"],
    ...
    if args.input:
        ...
        if args.output:
            if os.path.isdir(args.output):
                ...
                output_fname_last=video_input_name.split('.')[-1:]
